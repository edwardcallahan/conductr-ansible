...
The playbook build-cluster-ec2.yml launches three clusters nodes running both the core and the agent processes as well as a small template instance for imaging. Be certain to review and customize the vars file before building the cluster. 
